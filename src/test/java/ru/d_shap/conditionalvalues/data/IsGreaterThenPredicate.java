 ...
 * is greater then the value in the {@link ru.d_shap.conditionalvalues.ValueSet}.
 *
 * @author Dmitry Shapovalov
 */
public final class IsGreaterThenPredicate implements Predicate {

    /**
     * Create new object.
     */
    public IsGreaterThenPredicate() {
        super();
    }
    ...
    public boolean evaluate(final String conditionName, final Object conditionSetValue, final Object valueSetValue) {
        ...
        return conditionSetValueInt > valueSetValueInt;
    }
