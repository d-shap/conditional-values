...
public final class SomeValuesMatchSetPredicateTest {
    ...
    public void evaluateTest() {
        ...
        Assertions.assertThat(new SomeValuesMatchSetPredicate(-1, 5).evaluate("", new StringContainsPredicate(), "val", DataHelper.createHashSet((Object) "xval", "yval", "zval"))).isFalse();
        Assertions.assertThat(new SomeValuesMatchSetPredicate(-1, 5).evaluate("", new StringContainsPredicate(), "xval", DataHelper.createHashSet((Object) "xval", "yval", "zval"))).isTrue();
        Assertions.assertThat(new SomeValuesMatchSetPredicate(-1, 5).evaluate("", new StringContainsPredicate(), "yval", DataHelper.createHashSet((Object) "xval", "yval", "zval"))).isTrue();
        Assertions.assertThat(new SomeValuesMatchSetPredicate(-1, 5).evaluate("", new StringContainsPredicate(), "zval", DataHelper.createHashSet((Object) "xval", "yval", "zval"))).isTrue();
        Assertions.assertThat(new SomeValuesMatchSetPredicate(0, 5).evaluate("", new StringContainsPredicate(), "val", DataHelper.createHashSet((Object) "xval", "yval", "zval"))).isFalse();
        Assertions.assertThat(new SomeValuesMatchSetPredicate(0, 5).evaluate("", new StringContainsPredicate(), "xval", DataHelper.createHashSet((Object) "xval", "yval", "zval"))).isTrue();
        Assertions.assertThat(new SomeValuesMatchSetPredicate(0, 5).evaluate("", new StringContainsPredicate(), "yval", DataHelper.createHashSet((Object) "xval", "yval", "zval"))).isTrue();
        Assertions.assertThat(new SomeValuesMatchSetPredicate(0, 5).evaluate("", new StringContainsPredicate(), "zval", DataHelper.createHashSet((Object) "xval", "yval", "zval"))).isTrue();
        Assertions.assertThat(new SomeValuesMatchSetPredicate(1, 5).evaluate("", new StringContainsPredicate(), "val", DataHelper.createHashSet((Object) "xval", "yval", "zval"))).isFalse();
        Assertions.assertThat(new SomeValuesMatchSetPredicate(1, 5).evaluate("", new StringContainsPredicate(), "xval", DataHelper.createHashSet((Object) "xval", "yval", "zval"))).isTrue();
        Assertions.assertThat(new SomeValuesMatchSetPredicate(1, 5).evaluate("", new StringContainsPredicate(), "yval", DataHelper.createHashSet((Object) "xval", "yval", "zval"))).isTrue();
        Assertions.assertThat(new SomeValuesMatchSetPredicate(1, 5).evaluate("", new StringContainsPredicate(), "zval", DataHelper.createHashSet((Object) "xval", "yval", "zval"))).isTrue();
        Assertions.assertThat(new SomeValuesMatchSetPredicate(2, 5).evaluate("", new StringContainsPredicate(), "val", DataHelper.createHashSet((Object) "xval", "yval", "zval"))).isFalse();
        Assertions.assertThat(new SomeValuesMatchSetPredicate(2, 5).evaluate("", new StringContainsPredicate(), "xval", DataHelper.createHashSet((Object) "xval", "yval", "zval"))).isFalse();
        Assertions.assertThat(new SomeValuesMatchSetPredicate(2, 5).evaluate("", new StringContainsPredicate(), "yval", DataHelper.createHashSet((Object) "xval", "yval", "zval"))).isFalse();
        Assertions.assertThat(new SomeValuesMatchSetPredicate(2, 5).evaluate("", new StringContainsPredicate(), "zval", DataHelper.createHashSet((Object) "xval", "yval", "zval"))).isFalse();
        Assertions.assertThat(new SomeValuesMatchSetPredicate(3, 5).evaluate("", new StringContainsPredicate(), "val", DataHelper.createHashSet((Object) "xval", "yval", "zval"))).isFalse();
        Assertions.assertThat(new SomeValuesMatchSetPredicate(3, 5).evaluate("", new StringContainsPredicate(), "xval", DataHelper.createHashSet((Object) "xval", "yval", "zval"))).isFalse();
        Assertions.assertThat(new SomeValuesMatchSetPredicate(3, 5).evaluate("", new StringContainsPredicate(), "yval", DataHelper.createHashSet((Object) "xval", "yval", "zval"))).isFalse();
        Assertions.assertThat(new SomeValuesMatchSetPredicate(3, 5).evaluate("", new StringContainsPredicate(), "zval", DataHelper.createHashSet((Object) "xval", "yval", "zval"))).isFalse();
